  ...
  <div class="flex flex-wrap -mx-3 mb-2">
   ...
   <div>
       <label class="block text-sm font-medium text-gray-700">
        ...
        <textarea name="img" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  type="text" placeholder="Image Source"></textarea>
